...
export default function AboutPageSectionOne() {
  ...
  const [routesProgress, setRoutesProgress] = useState(0);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-6">
            ...
            >
              ...
              <div 
                className={`mb-4 h-0.5 bg-[#f7941d] transition-all duration-1000 ease-out delay-200 ${
                  showHeader 
                    ? 'w-14' 
                    : 'w-0'
                }`}
            ...
            {/* Title - Animated */}
            <h2 
              className={`text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-6 transition-all duration-1000 ease-out ${
                showTitle 
            ...
            {/* Since line - Animated */}
            <div 
              className={`flex items-center gap-3 text-gray-700 font-semibold mb-4 transition-all duration-800 ease-out delay-200 ${
                showCompanyInfo 
                  ? 'transform translate-x-0 opacity-100' 
            ...
            <p 
              className={`text-gray-700 leading-relaxed mb-8 max-w-prose text-base lg:text-lg transition-all duration-800 ease-out ${
                showDescription 
                  ? 'transform translate-y-0 opacity-100' 
                  : 'transform translate-y-4 opacity-0'
              }`}
            >
              Cascade Logistics Limited is a leading shipping and logistics provider specializing in air cargo services 
              from UK, China, USA, and Turkey to Ghana. We offer comprehensive solutions including clearing, customs processing, 
              and haulage services. Our expert team ensures reliable, transparent, and on-time delivery of your goods, 
              connecting businesses across continents with excellence and care.
            </p>

            {/* Progress bars - Animated */}
            <div 
              className={`grid grid-cols-1 md:grid-cols-3 gap-6 mb-10 transition-all duration-800 ease-out ${
                showProgressBars 
                  ? 'transform translate-y-0 opacity-100' 
            ...
            {/* Button - Animated */}
            <div 
              className={`mt-2 transition-all duration-800 ease-out ${
                showButton 
          ...
          <div className="lg:col-span-6">
            <div className="relative">
              ...
              <div 
                className={`hidden md:flex items-start gap-3 absolute left-0 -bottom-20 bg-gradient-to-r from-[#315694] to-[#262262] text-white rounded-xl shadow-2xl px-6 py-5 w-[370px] transition-all duration-1000 ease-out ${
                  showQuoteCard 
                    ? 'transform translate-y-0 opacity-100 scale-100' 
              ...
              >
                <div 
                  className={`shrink-0 w-10 h-10 rounded-full bg-white/10 flex items-center justify-center transition-all duration-600 ease-out delay-200 ${
                    showQuoteCard 
                      ? 'transform rotate-0 scale-100' 
                ...
                <div 
                  className={`flex-1 transition-all duration-700 ease-out delay-300 ${
                    showQuoteCard 
                      ? 'transform translate-x-0 opacity-100' 
                      : 'transform translate-x-4 opacity-0'
                  }`}
                ...
                <div 
                  className={`ml-auto opacity-20 transition-all duration-600 ease-out delay-400 ${
                    showQuoteCard 
                      ? 'transform rotate-0 scale-100' 
            ...
            <div 
              className={`md:hidden mt-6 bg-gradient-to-r from-[#315694] to-[#262262] text-white rounded-xl shadow-2xl p-5 flex items-start gap-3 transition-all duration-800 ease-out ${
                showQuoteCard 
                  ? 'transform translate-y-0 opacity-100 scale-100' 
                  : 'transform translate-y-6 opacity-0 scale-95'
              }`}
